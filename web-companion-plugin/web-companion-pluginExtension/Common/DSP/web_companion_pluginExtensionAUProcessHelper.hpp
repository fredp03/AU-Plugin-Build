//
//  web_companion_pluginExtensionAUProcessHelper.hpp
...
#include <vector>
#include "web_companion_pluginExtensionDSPKernel.hpp"
#include "web_companion_pluginExtensionBufferedAudioBus.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(web_companion_pluginExtensionDSPKernel& kernel, BufferedInputBus& bufferedInputBus)
    : mKernel{kernel},
...
private:
    web_companion_pluginExtensionDSPKernel& mKernel;
