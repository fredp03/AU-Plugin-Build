//
//  web_companion_pluginExtensionAudioUnit.swift
...
public class web_companion_pluginExtensionAudioUnit: AUAudioUnit, @unchecked Sendable
{
	// C++ Objects
	var kernel = web_companion_pluginExtensionDSPKernel()
