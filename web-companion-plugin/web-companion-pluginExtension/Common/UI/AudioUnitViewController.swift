...
private let log = Logger(subsystem: "Fred.web-companion-pluginExtension", category: "AudioUnitViewController")

@MainActor
public class AudioUnitViewController: AUViewController, AUAudioUnitFactory {
    var audioUnit: AUAudioUnit?
    
    var hostingController: HostingController<web_companion_pluginExtensionMainView>?
	...
	*/
	...
	nonisolated public func createAudioUnit(with componentDescription: AudioComponentDescription) throws -> AUAudioUnit {
		return try DispatchQueue.main.sync {
			...
			audioUnit = try web_companion_pluginExtensionAudioUnit(componentDescription: componentDescription, options: [])
			
			guard let audioUnit = self.audioUnit as? web_companion_pluginExtensionAudioUnit else {
				log.error("Unable to create web_companion_pluginExtensionAudioUnit")
				return audioUnit!
			}
			...
			audioUnit.setupParameterTree(web_companion_pluginExtensionParameterSpecs.createAUParameterTree())
    ...
    private func configureSwiftUIView(audioUnit: AUAudioUnit) {
        ...
        let content = web_companion_pluginExtensionMainView(parameterTree: observableParameterTree)
