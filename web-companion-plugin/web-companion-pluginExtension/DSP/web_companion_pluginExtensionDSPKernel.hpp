//
//  web_companion_pluginExtensionDSPKernel.hpp
...
#import "web_companion_pluginExtensionParameterAddresses.h"

/*
 web_companion_pluginExtensionDSPKernel
 As a non-ObjC class, this is safe to use from render thread.
 */
class web_companion_pluginExtensionDSPKernel {
public:
    ...
    void setParameter(AUParameterAddress address, AUValue value) {
        switch (address) {
            case web_companion_pluginExtensionParameterAddress::gain:
                mGain = value;
                break;
                // Add a case for each parameter in web_companion_pluginExtensionParameterAddresses.h
        }
    }
    ...
    void process(std::span<float const*> inputBuffers, std::span<float *> outputBuffers, AUEventSampleTime bufferStartTime, AUAudioFrameCount frameCount) {
        /*
         ...
         modify the check in [web_companion_pluginExtensionAudioUnit allocateRenderResourcesAndReturnError]
         */
